...
class S03E02ModelCustomization:
    ...
    def feature_engineering(
        cls, raw_df: pl.LazyFrame, target_column: str
    ) -> pl.LazyFrame:
    ...
    categorical_features: ClassVar[set[str]] = {
        "gender",
        "hypertension",
        "heart_disease",
        "ever_married",
    ...
    cyclical_features: ClassVar[dict[str, float]] = {}

    numerical_features: ClassVar[set[str]] = {
        "age",
        "avg_glucose_level",
        "bmi",
    }
    ...
    def get_class_weights(
        cls, train_file: Path, target_column_name: str = "classification_target"
    ) -> dict[float, float]:
